...
function chatGenerator(index) {
    const names = ["Maa", "Aman", "Darish", "Hardik", "Sakshi", "Saurya", "Myself", "Mama", "Prakash Jha", "Prakhar gupta", "Toshit", "Aryan kothiyal", "Asmit", "Dhruv Gupta", "Abhash", "Rudradip", "IITP MNC UNOFFICIAL' 25", "Myself", "Pete Sariya", "Monty Carlo", "Sal Monella", "Sue Vaneer", "Cliff Hanger", "Barb Dwyer", "Terry Aki", "Cory Ander", "Robin Banks", "Jimmy Changa", "Barry Wine", "Wilma Mumduya", "Buster Hyman", "Poppa Cherry", "Zack Lee", "Don Stairs", "Saul T. Balls", "Peter Pants", "Hal Appeno", "Otto Matic", "Moe Fugga", "Graham Cracker", "Tom Foolery", "Al Dente", "Bud Wiser", "Polly Tech", "Holly Graham", "Frank N. Stein", "Cam L. Toe", "Pat Agonia", "Tara Zona", "Barry Cade"]
